...
<<<<<<< HEAD
  function index()
  {
    ...
    $result = $pdo->query("SELECT id,title,description,categoryId,brandId,merchantId FROM OFFERS WHERE title LIKE '%iphone%'");
...
>>>>>>> 4b28f89f23d2944880b7b96d11a7c7bc1a379c26
    }
  }
